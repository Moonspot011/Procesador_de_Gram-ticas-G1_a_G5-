...
{
  "\"end of file\"", "error", "\"invalid token\"", "LINE", "$accept",
  "input", "lines", "line", YY_NULLPTR
};
...
#line 85 "gramatica.y"
                      {
                         line_count++;
                         if (!matches_any_grammar((yyvsp[0].str))) all_ok = 0;
                         free((yyvsp[0].str));
                      }
#line 1119 "gramatica.tab.c"
    break;


#line 1123 "gramatica.tab.c"
...
int main(int argc, char** argv) {
    ...
    if (line_count == 0) {
        printf("NO acepta\n");   // igual que tu Python cuando no hay líneas no vacías
    } else {
